...
#ifdef __sgi
/* big-endian: the low byte of the first word is the type field */
#define SL_PDTYPE(o) ((u8) (o)[0])
#else
#define SL_PDTYPE(o) (((PropDefHeaderRecord *) (o))->type)
#endif
...
void cleanupObjects(s32 stage)
{
    ...
    if (obj)
    {
        while (SL_PDTYPE(obj) != PROPDEF_END)
        {
            switch (SL_PDTYPE(obj))
            {
                case PROPDEF_DOOR:
                case PROPDEF_PROP:
                case PROPDEF_KEY:
