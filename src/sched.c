...
#ifndef __sgi
/* Native accessor so the platform layer can drive the game's own retrace
 * handler without taking a dependency on the OSSched type. */
void *sl_os_scheduler_ptr(void) { return &os_scheduler; }
#endif
